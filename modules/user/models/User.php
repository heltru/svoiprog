 ...
 * @property string $goo_access_token
 * @property string $goo_refresh_token
 * @property string $goo_token
 * @property integer $goo_access_token_created
 */
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            ['show_test_data','integer'],

            ['goo_access_token','string'],
            ['goo_refresh_token','string'],
            ['goo_access_token_created','integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'show_test_data'=>'Показывать тестовые данные',
            'def_template'=>'Дефолтный шаблон',
        ];
    }
    ...
    */
    ...
    public function getShow_test_data(){
        return $this->show_test_data;
    }
}
