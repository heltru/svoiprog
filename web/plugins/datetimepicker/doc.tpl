...
<p><input id="datetimepicker" value="2014/03/15 05:06" /></p>
<h3>Use mask DateTimepicker</h3>
<p><input id="datetimepicker_mask" value="" /></p>
<h3>TimePicker</h3>
<p><input id="datetimepicker1" /></p>
<h3>DatePicker</h3>
<p><input id="datetimepicker2" /></p>
<h3>Inline DateTimePicker</h3>
<p><input id="datetimepicker3" /></p>
<h3>Dark theme</h3>
<p><input id="datetimepicker_dark" /></p>
...
<p>HTML</p>
<pre><code data-language="html">&lt;input id="datetimepicker" &gt;</code></pre>
<p><strong>javaScript</strong></p>
<pre><code data-language="javascript">jQuery('#datetimepicker').datetimepicker();</code></pre>
<p><strong>Result</strong></p>
<p><input id="_datetimepicker" value="2014/03/15 05:06" /></p>
<script type="text/javascript">// <![CDATA[
...
<p><strong>Result</strong></p>
<p><input id="_datetimepicker1" value="15.08.2013" /></p>
<script type="text/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p><input id="_datetimepicker2" value="23:16" /></p>
<script type="text/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p><input id="datetimepicker_start_time" /></p>
<script type="text/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p><input id="datetimepicker_unixtime" /></p>
<script type="text/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p><input id="_datetimepicker3" value="10.12.2013 23:45" /></p>
<script type="text/javascript">// <![CDATA[
jQuery(function(){
...
<div class="row">
<div class="col-lg-6">
<div class="input-group"><input id="_datetimepicker4" class="form-control" value="10.12.2013 23:45" /></div>
<!-- /input-group --></div>
<!-- /.col-lg-6 --></div>
<!-- /.row -->
<script type="text/javascript">// <![CDATA[
...
<p><strong>Result</strong></p>
<p><input id="_datetimepicker5" value="23:45" /></p>
<script type="text/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p><input id="_datetimepicker6" value="" /></p>
<script type="text/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p><input id="_datetimepicker7" value="" /></p>
<script type="text/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p><input id="_datetimepicker_mask" value="" /></p>
<script type="text/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p><input id="_datetimepicker_runtime" value="" /></p>
<script type="text/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p><input id="_datetimepicker_ongenerate" value="" /></p>
<script type="text/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p><input id="_datetimepicker_weekends_disable" value="" /></p>
<script type="text/javascript">// <![CDATA[
jQuery(function(){
...
<p><strong>Result</strong></p>
<p>Start <input id="date_timepicker_start" value="" />  End <input id="date_timepicker_end" value="" /></p>
<script type="text/javascript">// <![CDATA[
jQuery(function(){
  jQuery('#date_timepicker_start').datetimepicker({
    format:'Y/m/d',
